...
public interface Aligner extends Receiver {
	...
	public Future<SubGraph> subGraphWithStrongInducedEdges(ExecutionContextExecutor executionContextExecutor,boolean mode,int simTreshold, int annotationTreshold,int powerTreshold);
