...
try:
    import fastsemsim.ontology.Ontology
    import fastsemsim.ac.AnnotationCorpus
    import fastsemsim.semsim.ObjSetSemSim
...
GENE_ONTOLOGY_FILE = "__gene_ontology_ext.obo"
...
if __name__ == "__main__":
    ...
    ontology = fastsemsim.load_ontology(source_file = GENE_ONTOLOGY_FILE,ontology_type = 'GeneOntology', file_type = 'obo')
#   ontology = fastsemsim.load_ontology(ontology_type = 'GeneOntology')
    ac_source_file = 'all_isobase.go'
    ac_source_file_type = 'plain'
    ac = fastsemsim.load_ac(ontology, source_file=ac_source_file, file_type=ac_source_file_type, species=None)
#    ac.parse(acFile, acSourceType, acParams)
#    ac.isConsistent()
# semsim_type::: 'obj', 'term', 'termset', 'objset'
    semsim_type='obj'
    semsim_measure='Resnik'
    mixing_strategy='max'
    scoreFunction = fastsemsim.init_semsim(ontology = ontology, ac = ac, semsim_type = semsim_type, semsim_measure = args.semsim, mixing_strategy = args.mode) 
        ...
        with open(args.output,'w') as f:
            ...
            for geneA,geneB in zip(geneListA, compareList):
                ...
                try:
                    ...
                    score = None
                print(args.mode,geneA,geneB,score)
