...
if __name__ == "__main__":
    ...
    ac = fastsemsim.load_ac(ontology)
...
# semsim_type::: 'obj', 'term', 'termset', 'objset'
    ...
    mixing_strategy='max'
    scoreFunction = fastsemsim.init_semsim(ontology = ontology, ac = ac, semsim_type = 'objset', semsim_measure = args.semsim, mixing_strategy = args.mode) 
